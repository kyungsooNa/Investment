...
class TestChartPaper:
    def test_get_chart_daily(self, paper_client, mock_paper_ctx):
        ...
        assert body["rt_cd"] == "0"
        from common.types import Exchange
        mock_paper_ctx.stock_query_service.get_ohlcv.assert_awaited_once_with("005930", "D", caller="stock.py - get_stock_chart", exchange=Exchange.KRX)
    ...
    def test_get_chart_weekly(self, paper_client, mock_paper_ctx):
        ...
        assert resp.status_code == 200
        from common.types import Exchange
        mock_paper_ctx.stock_query_service.get_ohlcv.assert_awaited_once_with("005930", "W", caller="stock.py - get_stock_chart", exchange=Exchange.KRX)
    ...
    def test_get_chart_monthly(self, paper_client, mock_paper_ctx):
        ...
        assert resp.status_code == 200
        from common.types import Exchange
        mock_paper_ctx.stock_query_service.get_ohlcv.assert_awaited_once_with("005930", "M", caller="stock.py - get_stock_chart", exchange=Exchange.KRX)
    ...
    def test_get_chart_yearly(self, paper_client, mock_paper_ctx):
        ...
        assert resp.status_code == 200
        from common.types import Exchange
        mock_paper_ctx.stock_query_service.get_ohlcv.assert_awaited_once_with("005930", "Y", caller="stock.py - get_stock_chart", exchange=Exchange.KRX)
