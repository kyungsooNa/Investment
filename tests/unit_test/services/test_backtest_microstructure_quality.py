...
def test_orderbook_db_coverage_is_gated_for_new_payloads():
    payload = _es_payload({
        "A": [{"time": "090001", "strength": 110.0}],
        "B": [{"time": "090001", "strength": 120.0}],
    })
