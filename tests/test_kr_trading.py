...
async def test_place_stock_order_buy_success():
    ...
    trading_api = KoreaInvestTradingAPI("https://mock.api", {}, mock_config, mock_logger)
...
async def test_get_hashkey_success(mock_post):
    ...
    trading_api = KoreaInvestTradingAPI('https://mock.api', {}, mock_config, MagicMock())
...
async def test_get_hashkey_network_error(mock_post):
    trading_api = KoreaInvestTradingAPI('https://mock.api', {}, {
        'base_url': 'https://mock.api',
        'api_key': 'abc',
        'api_secret_key': 'def'
    }, MagicMock())
