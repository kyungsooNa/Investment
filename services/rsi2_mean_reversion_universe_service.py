"""RSI2 mean-reversion specific liquidity universe service.

GenericLiquidityUniverseService 와 동일한 거래대금/시총 baseline 위에
20일 annualized close-to-close 변동성 floor 를 추가로 적용한다.
변동성이 너무 낮은 종목은 RSI(2) oversold 도달 빈도가 낮아
mean-reversion 진입 신호 자체가 발생하지 않으므로 prefilter 단계에서 제외한다.

용도: P2-2 universe 적합성 비교 ablation 변형 (`universe_rsi2_mean_reversion`).
"""
...
class Rsi2MeanReversionUniverseService:
    ...
    def __init__(
        ...
        *,
        ...
        min_volatility_20d_annualized: float = 0.30,
