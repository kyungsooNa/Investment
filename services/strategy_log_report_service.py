...
from services.strategy_execution_quality_report import ExecutionQualityReportBuilder
from services.strategy_report_format import _esc, _first_number, _to_float
...
class StrategyLogReportService:
    ...
    def __init__(
        ...
        self._execution_quality_builder = ExecutionQualityReportBuilder(execution_quality_config)
    ...
    def get_last_execution_quality_candidates(self) -> List[dict]:
        ...
        return self._execution_quality_builder.get_last_candidates()
    ...
    async def generate_report(self, target_date: str) -> str:
        ...
        self._execution_quality_builder.reset_candidates()
        self._last_strategy_degradation_candidates = []
            ...
            for fpath in sorted(files):
                for _level, ts, data in self._iter_events(fpath, date_prefix):
                    ...
                    strategy_candidate_liquidity_records.extend(
                        self._execution_quality_builder.extract_candidate_liquidity_records(
                            name, ts, data, name_map,
                        )
                    )
        ...
        execution_quality_section = self._execution_quality_builder.build_execution_quality_section(
        ...
        candidate_liquidity_section = self._execution_quality_builder.build_candidate_liquidity_section(
            candidate_liquidity_records,
        )
