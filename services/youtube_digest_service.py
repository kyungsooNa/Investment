...
_DIGEST_SYSTEM_PROMPT = (
    ...
    "알림의 첫 화면만 읽어도 결론을 알 수 있도록 가장 먼저 '핵심 요약' 섹션을 둔다. "
    "핵심 요약에는 하루치 방송 전체를 압축한 한 문장 결론을 인용문으로 쓰고, "
    "그 아래에 '주요 기회'와 '주요 위험'을 각각 1~3개 불릿으로 쓴다. "
    "단순 종목 나열보다 공통된 시장 방향, 촉매, 경계 요인을 우선하며 과장된 목표가는 "
    "핵심 요약에서 강조하지 않는다. "
    "이후 한국어로 '오늘의 공통 화두', '많이 언급된 종목', '엇갈리는 시각', "
    "'단독 언급', '확인이 필요한 주장' 순서의 짧은 상세 섹션으로 답한다."
)
