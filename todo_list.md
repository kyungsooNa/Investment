...
14. [프로그램매매] 선택한 종목바꿀때 차트만 잘바뀌고 표는 제대로 반영이 안됨.
  ...
  + 10시가되면 구독이 끊기는거같음. 재연결 로직이 정상동작 안하는건지?
  + 아니면 window 보호기 모드로 들어가면 안하는걸수도 있음.
...
17. Log에 file 10M 크기로 분리할때 생성되는 이름이 .log뒤에 새롭게 넘버링됨 (e.g. 20260227_115854_debug.log.2)
 + 20260227_115854_debug_2.log 방식으로 변경 필요
