...
- [ ] **[외부 메신저]** telegram에 외국인/기관/개인/프로그램 순매수/순매도 결과를 report로 보내기 위한 repoter class 기능을 추가.
- [x] **[외부 메신저]** telegram에 외국인/기관/개인/프로그램 순매수/순매도 결과를 report로 보내기 위한 repoter class 기능을 추가.
...
- [ ] **[투자결과]** 계좌잔고, 랭킹,시가총액,모의투자기록,스케줄러,프로그램매매 view에서 종목명(or 종목코드)를 선택하면 현재가 조회 창으로 넘어가서 해당 종목의 현재가 조회하는 기능 추가.
