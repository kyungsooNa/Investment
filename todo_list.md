...
5. **[착수 가능 — 외부 의존 없음]** (**2026-09-17 재충전** — 08-30 에 비웠던 그룹을 이번 점검에서 발견한 2건으로 다시 채운다. 아래 ①이 크리티컬 패스에 더 가깝다.)
...
- [ ] **(신규 2026-09-17, 착수 가능 — 위 우선순위 5-②) 계약표가 낡았다: 08-18 이후 늘어난 알림 5계열이 미등재**
