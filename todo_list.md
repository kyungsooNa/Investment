...
- [ ] **[전략]** 오닐PP/BGU 에서 매수/매도 수량이 안맞음. 전체 전략별로 검증.
- [ ] **[전략]** 장마감 이후 새롭게 App실행시 전략 수행여부 승계안됨.
- [ ] **[전략]** 장마감 시간 조정 현재 15:30 -> 동시호가 15:20, 장마감 KRX (15:40) NXT(08:00)
  전략에서 장마감전 청산은 동시호가(15:20) -10분으로 조정하고 background scheduler가 도는 시간은 KRX 장마감(15:40) + 10분으로 수정
- [ ] **[전략]** 첫 눌림목에서 부분익절(50%)시 보유종목에서 날아가버리는듯.
