...
최종 업데이트: 2026-05-26 (P1 1-2 walk-forward gate metric 연결 반영)
...
1. **즉시 코드/정책 작업**
   - purged/embargo split 또는 같은 종목·인접 기간 누수 방지용 validation contract 정의 (P1 1-2)
   - ablation 결과를 전략 승격 기준에 반영 (P1 1-2)
